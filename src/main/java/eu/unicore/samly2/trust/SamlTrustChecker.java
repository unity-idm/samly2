...
public interface SamlTrustChecker
{
	 ...
	 */
	void checkTrust(SAMLUtils.XMLBeansWithDom<AssertionDocument> assertionDoc,
			ResponseTrustCheckResult responseCheckResult)
			throws SAMLValidationException;

	void checkTrust(SAMLUtils.XMLBeansWithDom<AssertionDocument> assertionDoc) throws SAMLValidationException;
